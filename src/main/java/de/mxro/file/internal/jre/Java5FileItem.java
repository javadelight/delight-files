...
public class Java5FileItem implements FileItem {
	...
	public FileItem find(final String pattern) {
		...
		return new NotExistentFileItem(null, this);
	}
	...
	/**
	 * based on method from Apache Commons IO under Apache 2 license: http://commons
	...
	public FileItem getParent() {
		...
		if (!parent.exists()) {
			return new NotExistentFileItem(null, null);
		}
